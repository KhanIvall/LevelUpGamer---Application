...
import com.example.pokestore.model.DetallePedido
import com.example.pokestore.model.Pedido
import com.example.pokestore.model.Producto
import com.example.pokestore.model.Usuario
...
@Database(
    ...
    version = 1 // Puedes reiniciar la versión a 1 ya que es una app nueva
)
abstract class LevelUpDatabase : RoomDatabase() {

    // 1. Aquí exponemos los DAOs que creamos anteriormente
